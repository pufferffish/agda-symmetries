...
\begin{definition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.QFreeMon.html#991}{link}}
...
\begin{proposition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.QFreeMon.html#3901}{link}}
...
\begin{definition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.QFreeMon.html#4883}{link}}
...
\begin{proposition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.QFreeMon.html#5913}{link}}
...
\begin{definition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.PList.html#738}{link}}
    \leavevmode
    \begin{code}
...
\begin{proposition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.PList.html#3821}{link}}\label{plist:sharp-sat}
...
\begin{definition}{\href{https://windtfw.com/agda-symmetries/Cubical.HITs.FiniteMultiset.Properties.html#410}{link}}
...
\begin{lemma}{\href{https://windtfw.com/agda-symmetries/Cubical.HITs.FiniteMultiset.Properties.html#1033}{link}}\label{slist:cons}
...
\begin{theorem}{\href{https://windtfw.com/agda-symmetries/Cubical.HITs.FiniteMultiset.Properties.html#1180}{link}}\label{slist:comm}
...
\begin{definition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Base.html#1307}{link}}
    \label{def:bag}
    \leavevmode
    \begin{code}
...
\begin{proposition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Free.html#16643}{link}}
...
\begin{proposition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Free.html#2362}{link}}\label{bag:cong}
...
\begin{proposition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Free.html#3373}{link}}\label{bag:comm}
...
\begin{proposition}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Free.html#16035}{link}}
...
This proof was particularly hard to prove and it took two weeks to prove this.
The main insight comes from the proof of isomorphism between $\Bag$ and $\PList$
in~\cite{choudhuryFreeCommutativeMonoids2023}, where the proof is split into
two cases: one where $\phi(0) = 0$ and one where $\phi(0) = S(n)$ for some $n$.
This led to the realization that the proof can be completed inductively
if $\phi(0) = 0$, and all that remains is to bridge the proof from
$\phi(0) = S(n)$ to $\phi(0) = 0$.

\begin{lemma}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Free.html#7321}{link}}\label{bag:tau}
...
\begin{proof}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Free.html#5237}{link}}
...
\begin{theorem}{\href{https://windtfw.com/agda-symmetries/Cubical.Structures.Set.CMon.Bag.Free.html#14132}{link}}\label{bag:perm-sat}
