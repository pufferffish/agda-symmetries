...
%
For example, these two trees should be identified as equal, but they're not.~\todo{draw trees}.
%
...
\begin{example}
    The system of equations for monoids: \vc{this is too tedious to typeset, see the Agda code instead.}
\end{example}
