...
\redtext{Outline: what works for both, what doesn't work for both? head.}
\redtext{Coproducts of free algebras, coproducts of free commutative monoids, draw a picture.}
\redtext{Point to conical and Riesz refinement property}
\redtext{Say something about Path space.}
\redtext{Cons is injective.}
