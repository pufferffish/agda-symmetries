...
We have already given a proof of $\List$ being the free monoid in~\ref{mon:list}.
...
\vc{Say that everything henceforth holds for any presentation of free monoids and free commutative monoids, by univalence and SIP.}